...
private:
    ...
    u_int watchtime;
public:
    Stats_content(u_int _month = 0, u_int _year = 0, u_int _impression = 0, u_int _coverage = 0, u_int _like = 0, u_int _dislike = 0, u_int _numcomments = 0, u_int _views = 0, u_int _watchtime = 0);
