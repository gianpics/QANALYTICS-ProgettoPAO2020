...
Stats_account::Stats_account(QDate _date, u_int _coverage, u_int _impression, u_int _like, u_int _followers) :  Stats(_date, _coverage, _impression, _like), followers(_followers){}
