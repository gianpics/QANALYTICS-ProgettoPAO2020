...
Stats_instagram::Stats_instagram(QDate _date, u_int _coverage, u_int _impression, u_int _like, u_int _followers, u_int _following) : Stats_account(_date, _coverage, _impression, _like, _followers), following(_following){}
