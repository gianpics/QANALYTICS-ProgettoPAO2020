...
void Controller::retrieveCreators()
{
    StatsList listsc;
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    listsa.clear(); listsa.PushBack(si2a); listsa.PushBack(si2b);
    ...
    listsa.clear(); listsa.PushBack(sf2a); listsa.PushBack(sf2b);
...
//---------------------------------------------------------------------------------------------------------------------------
    ...
    listsc.clear(); listsc.PushBack(sc10a); listsc.PushBack(sc10b);
    ...
    listsa.clear(); listsa.PushBack(sy3a); listsa.PushBack(sy3b);
